...
* SUMSQ(X#(),N%,SQX#) - calculate the sum of the square of array elements using the 80x87 math coprocessor, includes floating point conversion between IEEE-754 and MBF.
...
* STATSXY - combines SUM, SUMSQ, SUMXY for statistical analysis using the 80x87 math coprocessor, includes floating point conversion between IEEE-754 and MBF.
